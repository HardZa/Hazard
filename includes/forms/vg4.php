...
<div id="header" style="margin-bottom:0;font-size:25px;">ใบอนุญาตนำเข้าวัตถุอันตราย</div>
<br><br>
...
<p align="left">นำเข้าวัตถุอันตรายตามรายการ ดังต่อไปนี้<p>
...
<p align="left">ผู้ผลิต<input = "text" class="box" name="producer" style="width:500px"><p>
<p align="left">ประเทศที่ผลิต<input = "text" class="box" name="produceCountry" style="width:500px"><p>
