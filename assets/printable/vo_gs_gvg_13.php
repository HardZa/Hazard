...
<div align = "right">แบบ วอ./กษ./กวก.๑๓</div>	
...
<div class="text">
<br>
<div align="center">ใบอนุญาตผลิตตัวอย่างวัตถุอันตราย</div>
<br>	
<span class="right">
	<div align="left">
		กรมวิชาการเกษตร<br>
...
ชื่อและที่อยู่ของสถานที่ผลิต/เก็บรักษาวัตถุอันตราย ชื่อ <?php echo Input::get("storename"); ?><br>
...
<br>
ใบอนุญาตฉบับนี้ให้ใช้จนถึงวันที่ <span style="display:inline-block;background-color:#999;width:20px;"><?php echo Input::get("expday"); ?></span> เดือน <span class="box_2"><?php echo Input::get("expmonth"); ?></span> พ.ศ. <span class="box_3"><?php echo Input::get("expyear"); ?></span>
<br><br><br><br>
