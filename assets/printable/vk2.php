...
สถานที่ผลิตวัตถุอันตรายชื่อ <?php echo Input::get("productname"); ?><br>
ตั้งอยู่เลขที่ <span class="box_1"><?php echo Input::get("producthouse"); ?></span> หมู่ที่ <span class="box_1"><?php echo Input::get("productvillage"); ?></span> ตรอก/ซอย <span class="box_2"><?php echo Input::get("productdrive"); ?></span> ถนน <span class="box_2"><?php echo Input::get("productroad"); ?></span><br>
ตำบล/แขวง <span class="box_2"><?php echo Input::get("productsubdistrict"); ?></span> อำเภอ/เขต <span class="box_2"><?php echo Input::get("productdistrict"); ?></span> จังหวัด <span class="box_3"><?php echo Input::get("productprovince"); ?></span><br>
รหัสไปรษณีย์ <span class="box_3"><?php echo Input::get("productpostalcode"); ?></span> โทรศัพท์ <span class="box_3"><?php echo Input::get("productphone"); ?></span> โทรสาร <span class="box_3"><?php echo Input::get("productfax"); ?></span><br>
...
ชื่อผู้เชี่ยวชาญหรือบุคลากรเฉพาะรับผิดชอบสำหรับการผลิต (ในกรณีที่มีประกาศฯ ออกตามความในมาตรา ๒๐(๒) แห่งพระราชบัญญัติวัตถุอันตราย พ.ศ.๒๕๓๕ กำหนดให้ต้องมีผู้เชี่ยวชาญหรือบุคลากรเฉพาะรับผิดชอบฯ)<br> <span class="box_4"><?php echo Input::get("producerspecialist"); ?></span><br>
