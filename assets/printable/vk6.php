...
<br>
<div align="center">ใบอนุญาติส่งออกวัตถุอันตราย</div>
<br><br>
<div style="font-size:15px">
	...
	<br><br><br>
	<span>
		ใบสำคัญการขึ้นทะเบียนเลขที่ <?php echo Input::get("certidref"); ?>
	</span>
	<br>
		อนุญาตให้ 
	...
	<br>
	ส่งออกวัตถุอันตรายตามรายการ ดังต่อไปนี้<br>
	<span>
		ชื่อวัตถุอันตราย สูตรเคมี<sup>(๑)</sup>และอัตราส่วน<br>
		<?php echo Input::get("hazardname") ?>
	</span>
	<br>
	<span>
		ลักษณะและสูตร(Formulation)<sup>(๒)</sup> 
		<span class="box_4"><?php echo Input::get("hazardformulation"); ?></span>
	</span>
	<br>
	<span>
		ชื่อทางการค้า(ถ้ามี)
		<span class="box_4"><?php echo Input::get("businessname"); ?></span>
	</span>
	<br>
	<span>
		ประเทศปลายทาง
		<span class="box_4"><?php echo Input::get("orderCountry"); ?></span>
	</span>
	<br>
	<span>
		ปริมาณ
		<span class="box_4"><?php echo Input::get("quantity"); ?></span>
	</span>
	<br>
	<span>
		หมายเหตุ
		<span class="box_4"><?php echo Input::get("note"); ?></span>
	</span>
	<br>
	สถานที่เก็บรักษาวัตถุอันตรายตามรายการด้านหลังใบอนุญาตนี้
	<br>
	<span>
		ใบอนุญาตินี้ออกให้โดยมีเงื่อนไขดังต่อไปนี้<br>
		<?php echo Input::get("condition"); ?>
	</span>
	<br>
	<span>
...
<span>
	...
	<span class="box_4"> <?php echo Input::get("certid1"); ?> </span>
</span>
<br>
<span>
	สถานที่เก็บรักษาวัตถุอันตรายแห่งที่ ๑ ชื่อ
	<span class="box_4"> <?php echo Input::get("storename"); ?> </span>
</span>
<br>
<span>
	ตั้งอยู่เลขที่
...
<div style="font-size:10px">
	<span class="left">
		<u>หมายเหตุ</u>&nbsp;&nbsp;&nbsp;(๑)&nbsp;&nbsp;วัตถุอันตรายในความรับผิดชอบของสำนักงานคณะกรรมการอาหารและยา กรมวิชาการเกษตร กรมประมง 
		และกรมปศุสัตว์ไม่ต้องระบุสูตรเคมี			
	</span>
	<br>
	<span class="left">
			&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
