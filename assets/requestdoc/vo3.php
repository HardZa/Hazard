...
<div class="row">
	<div class="col-md-offset-4"><h3><b>คําขออนุญาตนําเข้าวัตถุอันตราย</b></h3></div>
</div>
<div class="row">
...
<br>
<div class="row">
	<div class="col-md-7"><u><b>ขออนุญาตนําเข้าวัตถุอันตรายตามรายการ ดังต่อไปนี้</b></u></div>
</div>
<div class="row">
...
<div class="row">
	<div class="col-md-11"><b>ผู้ผลิต</b> &nbsp;&nbsp;<?php echo doc('producer')?></div>
</div>
<div class="row">
	<div class="col-md-11"><b>ประเทศที่ผลิต</b> &nbsp;&nbsp;<?php echo doc('producerCountry')?></div>
</div>
...
<br>
	...
	<div class="row">
		<div class="col-md-11"><font size ="3">O</font> สําเนาใบสําคัญการขึ้นทะเบียนวัตถุอันตราย (ในกรณีที่ผู้ขออนุญาตนําเข้าได้ขึ้นทะเบียนไว้แล้ว) </div>
	</div>
	<div class="row">
		<div class="col-md-11"><font size ="3">O</font> สําเนาผลการวิเคราะห์วัตถุอันตราย</div>
	</div>
	<div class="row">
...
ออกตามความในมาตรา ๒๐ (๑) แห่งพระราชบัญญัติวัตถุอันตราย พ.ศ. ๒๕๓๕
ให้สถานที่เก็บรักษาวัตถุอันตรายต้องเป็นไปตามหลักเกณฑ์ที่กําหนด) </div>
	</div>
	<div class="row">
		<div class="col-md-11"><font size ="3">O</font> อกสารแสดงความรู้ความชํานาญของผู้เชี่ยวชาญหรือบุคลากรเฉพาะรับผิดชอบสําหรับการเก็บรักษา</div>
	</div>
	<div class="row">
