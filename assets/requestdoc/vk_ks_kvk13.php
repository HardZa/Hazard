...
<div class="row">
	<div class="col-md-offset-3"><h3><b>คําขอต่ออายุใบสําคัญการขึ้นทะเบียนวัตถุอันตราย</b></h3></div>
</div>
<br><br><br>
<div class="row">
	<div class="col-md-5"><b>ใบอนุญาตเลขที่</b> <?php echo doc('no'); ?></div>
	<div class="col-md-offset-9"><?php echo "วัน ".doc('day')." เดือน ".doc('month')." ปี ".doc('year'); ?></div>
	<br>
</div>

<div class="row">
	<div class="col-md-offset-1 col-md-5"><b>อนุญาตให้ </b> <?php echo doc('name'); ?></div>
...
<div class="row">
	<div class ="col-md-11"><b>พร้อมนี้ข้าพเจ้าได้แนบเอกสารเพื่อประกอบการพิจารณา ดังนี้</b></div>
</div>
<div class="col-md-offset-1">
	<div class="row">
		<div class="col-md-11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size ="3">O</font> ใบสําคัญการขึ้นทะเบียนวัตถุอันตราย</div>
	</div>
	<div class="row">
...
จํานวน 6 ชุด </div>
	...
	<div class="row">
		<div class="col-md-11">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<font size ="3">O</font> แผนการทดลองประสิทธิภาพและพิษตกค้าง (ถ้ามี) </div>
	</div>
	<div class="row">
