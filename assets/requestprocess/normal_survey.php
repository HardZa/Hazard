...
<form class="form-horizontal" method="post" action="" role="form" >
	<div class="form-group">
		<div class="row">
			...
			<label class="col-sm-3 control-label" style="margin-top: 12px;">ข้อมูลการสำรวจ </label>
		...
		<div class="row">
			<button type="submit" class="btn btn-warning" style="margin-left:136px;">ส่งผลการสำรวจ</button>
		</div>
	</div>
</form>
